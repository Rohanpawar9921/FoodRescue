...
<head>
    ...
    <title>List Surplus Food - FoodRescue Admin</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-14">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="index.php" class="text-white hover:bg-white hover:text-green-600 px-3 py-1.5 rounded-lg transition duration-300 text-sm font-medium">
...
<div class="gradient-bg text-white py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-slideIn">
        ...
        <h1 class="text-3xl md:text-4xl font-bold mb-2">List Your Surplus Food</h1>
        <p class="text-base text-green-100">Expand your catalog with amazing products</p>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 animate-fadeIn">
        <div class="flex items-center space-x-3 mb-6">
            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-pink-500 rounded-full flex items-center justify-center">
        ...
        <form id="addProduct" class="space-y-4">
            ...
            <div class="group">
                <label for="productName" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                    <i class="fas fa-tag mr-2 text-green-600 text-xs"></i>
                    Food Item Name
                </label>
                <input 
                    type="text" 
                    ...
                    required
                    class="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200 focus:border-green-500 outline-none transition duration-300 text-sm">
            </div>

            <!-- Discounted Price -->
            <div class="group">
                <label for="productPrice" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                    <i class="fas fa-rupee-sign mr-2 text-green-600 text-xs"></i>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        min="0"
                        required
                        class="w-full pl-10 pr-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200 focus:border-green-500 outline-none transition duration-300 text-sm">
                </div>
            </div>
            ...
            <div class="group">
                ...
                <select 
                    ...
                    name="category_id" 
                    required
                    class="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200 focus:border-green-500 outline-none transition duration-300 text-sm appearance-none bg-white cursor-pointer">
            ...
            <button 
                ...
                <span>List Surplus Food to Catalog</span>
            </button>
        </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-4 text-white shadow-md">
            ...
            <div class="text-green-100 text-sm">Simple Form</div>
        </div>
...
<footer class="bg-gray-900 text-white py-6 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p class="text-gray-400">&copy; 2026 FoodRescue Admin Panel. Manage your products with ease.</p>
    </div>
</footer>
        ...
        $("#addProduct").submit(function(e) {
            ...
            API.call('product', 'add', formData)
                .then(function(result) {
                    ...
                    setTimeout(() => {
                        const notification = $('<div class="fixed top-24 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-2xl flex items-center space-x-3 z-50 animate-slideIn">' +
